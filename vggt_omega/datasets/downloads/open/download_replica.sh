...
for p in a b c d e f g h i j k l m n o p q; do
    fetch_retry "$BASE/replica_v1_0.tar.gz.parta$p" "$DEST_DIR/replica_v1_0.tar.gz.parta$p"
done
...
fetch_retry "http://dl.fbaipublicfiles.com/habitat/Replica/additional_habitat_configs.zip" \
